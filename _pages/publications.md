...
* Data Integrity-by-Design: Combining Declarative Object-Centric Choreographies and Entity Relationship Models. T. Zuckmantel, H. A. López, **Y. Zhou**, B. Düdder, T. T. Hildebrandt. In 31th International Conference on Cooperative Information Systems (CoopIS 2025). 
...
* [gECC: A GPU-based high-throughput framework for Elliptic Curve Cryptography](https://dl.acm.org/doi/10.1145/3736176). Q. Xiong, W. Ma, X. Shi, **Y. Zhou**, H. Jin, K. Huang, H. Wang, Z. Wang. In ACM Transactions on Architecture and Code Optimization. 2025. 
* [DACEO: Declarative Asynchronous Choreographies with General Data-Dependent Event-Ordering and Objects](https://www.researchgate.net/publication/392793006_DACEO_Declarative_Asynchronous_Choreographies_with_General_Data-Dependent_Event-Ordering_and_Objects). T. Zuckmantel, **Y. Zhou**, B. Düdder, T. T. Hildebrandt. In COORDINATION 2025 - 27th International Conference on Coordination Models and Languages. 
